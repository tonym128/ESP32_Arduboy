...
//        sprites.drawOverwrite(20, 0, diamondsR, 0);    // Doesn't work (image have to be in  with this function)
...
// sprites.drawOverwrite(7, 0, diamondsR, 0);    // Doesn't work (image have to be in  with this function)
