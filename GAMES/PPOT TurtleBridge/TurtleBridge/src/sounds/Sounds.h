...
namespace Sounds {
  ...
  const uint16_t PackageDelivered[]  = { 220,50, 440,50, 880,50, TONES_END };

  const uint16_t PackagePickedUp[]  = { 440,50, 880,50, TONES_END };

  const uint16_t PackageNotDelivered[]  = { 440,50, 180,50, TONES_END };

  const uint16_t Turtle[]  = { 30, 50, 50, 50, TONES_END };

  const uint16_t Drowning[]  = {
