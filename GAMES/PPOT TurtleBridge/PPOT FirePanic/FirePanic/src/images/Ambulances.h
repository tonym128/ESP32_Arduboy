...
namespace Images {
  ...
  const uint8_t  armour_gauge_mask[] = {
  ...
  const uint8_t  armour_gauge_item[] = {
  3, 4,
  0x00, 0x06, 0x00, 
  };

  const uint8_t  armour_gauge_item_mask[] = {
  0x0f, 0x0f, 0x0f, 
  };
