...
namespace Images {
  ...
  #ifndef DEBUG
  const uint8_t  FirePanic_Logo_Mask[] = {
  ...
  const uint8_t  FirePanic_Logo_Anim_1[] = {
  4, 16,
  0x00, 0x40, 0xa0, 0x50, 
  0xaa, 0x55, 0xaa, 0x55, 
  ...
  const uint8_t  FirePanic_Logo_Anim_2[] = {
  4, 16,
  0x00, 0x00, 0x80, 0x00, 
  0xaa, 0x55, 0xaa, 0x55, 
  ...
  const uint8_t  FirePanic_Logo_Anim_3[] = {
  3, 16,
  0x00, 0x00, 0x00, 
  0xaa, 0x55, 0xaa, 
  ...
  const uint8_t  FirePanic_Logo_Anim_4[] = {
  4, 16,
  0x00, 0x40, 0x40, 0xe0, 
  0x54, 0xaa, 0x54, 0xa8, 
  ...
  const uint8_t  FirePanic_Logo_Anim_5[] = {
  4, 16,
  0xa8, 0x54, 0xa8, 0x50, 
  0xaa, 0x55, 0xaa, 0x55, 
  ...
  const unsigned char  Filmote_Mask[] = {
  ...
  const unsigned char  Vampirics_Mask[] = {
