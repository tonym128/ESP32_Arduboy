...
constexpr char word_000[]  = "\n";
constexpr char word_001[]  = "I";
constexpr char word_002[]  = "NEED";
constexpr char word_003[]  = "TO";
constexpr char word_004[]  = "TAKE";
constexpr char word_005[]  = "THAT";
constexpr char word_006[]  = "CORP";
constexpr char word_007[]  = "DOWN";
constexpr char word_008[]  = "AT";
constexpr char word_009[]  = "ALL";
constexpr char word_010[]  = "COSTS!";
constexpr char word_011[]  = "DAMN,";
constexpr char word_012[]  = "WASN'T";
constexpr char word_013[]  = "PERPARED";
constexpr char word_014[]  = "BREACH";
constexpr char word_015[]  = "THROUGH";
constexpr char word_016[]  = "THIS.";
constexpr char word_017[]  = "UP";
constexpr char word_018[]  = "GOES";
constexpr char word_019[]  = "MY";
constexpr char word_020[]  = "THREAT";
constexpr char word_021[]  = "LEVEL!";
constexpr char word_022[]  = "THANK";
constexpr char word_023[]  = "YOU";
constexpr char word_024[]  = "FOR";
constexpr char word_025[]  = "THE";
constexpr char word_026[]  = "INTEL!";
constexpr char word_027[]  = "WILL";
constexpr char word_028[]  = "WITH";
constexpr char word_029[]  = "YOUR";
constexpr char word_030[]  = "OWN";
constexpr char word_031[]  = "SHIT!";
constexpr char word_032[]  = "NOW";
constexpr char word_033[]  = "TERRY,";
constexpr char word_034[]  = "MAKE";
constexpr char word_035[]  = "IT";
constexpr char word_036[]  = "HOME.";
constexpr char word_037[]  = "JUST";
constexpr char word_038[]  = "INTEL";
constexpr char word_039[]  = "AVOID";
constexpr char word_040[]  = "NCPD'S";
constexpr char word_041[]  = "LAMEST.";
constexpr char word_042[]  = "HACK";
constexpr char word_043[]  = "THEIR";
constexpr char word_044[]  = "SYSTEMS";
constexpr char word_045[]  = "MORE";
constexpr char word_046[]  = "WHAT";
constexpr char word_047[]  = "HELL,";
constexpr char word_048[]  = "CAN'T";
constexpr char word_049[]  = "EVEN";
constexpr char word_050[]  = "GET";
constexpr char word_051[]  = "HOME";
constexpr char word_052[]  = "WITHOUT";
constexpr char word_053[]  = "A";
constexpr char word_054[]  = "FIGHT!";
constexpr char word_055[]  = "LET'S";
constexpr char word_056[]  = "HIT";
constexpr char word_057[]  = "WHERE";
constexpr char word_058[]  = "HURTS.";
constexpr char word_059[]  = "HOW";
constexpr char word_060[]  = "MUCH";
constexpr char word_061[]  = "UNCOVER";
constexpr char word_062[]  = "TODAY.";
constexpr char word_063[]  = "SELL";
constexpr char word_064[]  = "THEM";
constexpr char word_065[]  = "DOWN.";
constexpr char word_066[]  = "HE";
constexpr char word_067[]  = "CAN";
constexpr char word_068[]  = "CLEAR";
constexpr char word_069[]  = "NAME..";
constexpr char word_070[]  = "PRICE.";
constexpr char word_071[]  = "WHEN";
constexpr char word_072[]  = "PAYING";
constexpr char word_073[]  = "RIGHT";
constexpr char word_074[]  = "PEOPLE";
constexpr char word_075[]  = "LOWER";
constexpr char word_076[]  = "LEVEL";
constexpr char word_077[]  = "HERE.";
constexpr char word_078[]  = "HOPE";
constexpr char word_079[]  = "FIND";
constexpr char word_080[]  = "CONTACT";
constexpr char word_081[]  = "HELP";
constexpr char word_082[]  = "ME";
constexpr char word_083[]  = "OUT.";
constexpr char word_084[]  = "LET'S";
constexpr char word_085[]  = "SHOPS.";
constexpr char word_086[]  = "SOME";
constexpr char word_087[]  = "UPGRADES.";
constexpr char word_088[]  = "THERE";
constexpr char word_089[]  = "GETTING";
constexpr char word_090[]  = "CAUGHT.";
constexpr char word_091[]  = "IF";
constexpr char word_092[]  = "AM";
constexpr char word_093[]  = "STUCK,";
constexpr char word_094[]  = "REMOTE";
constexpr char word_095[]  = "HACKING";
constexpr char word_096[]  = "MIGHT";
constexpr char word_097[]  = "THOSE";
constexpr char word_098[]  = "CORPO";
constexpr char word_099[]  = "BASTARDS";
constexpr char word_100[]  = "PAY";
constexpr char word_101[]  = "THEY";
constexpr char word_102[]  = "HAVE";
constexpr char word_103[]  = "DONE.";
constexpr char word_104[]  = "BY";
constexpr char word_105[]  = "SERVERS";
constexpr char word_106[]  = "AND";
constexpr char word_107[]  = "GOOD.";
constexpr char word_108[]  = "ALLOW";
constexpr char word_109[]  = "FURTHER.";
constexpr char word_110[]  = "ONCE";
constexpr char word_111[]  = "HACKS";
constexpr char word_112[]  = "BEEN";
constexpr char word_113[]  = "COMPLETED.";
constexpr char word_114[]  = "PURCHASE";
constexpr char word_115[]  = "OR";
constexpr char word_116[]  = "SWAP";
constexpr char word_117[]  = "CONTINUE";
constexpr char word_118[]  = "CANNOT";
constexpr char word_119[]  = "AFFORD";
constexpr char word_120[]  = "ANY";
constexpr char word_121[]  = "UNFORTUNATELY,";
constexpr char word_122[]  = "TIME";
constexpr char word_123[]  = "HERE";
constexpr char word_124[]  = "IS";
constexpr char word_125[]  = "OVER!";
constexpr char word_126[]  = "CONGRATULATIONS!";
constexpr char word_127[]  = "TOOK";
constexpr char word_128[]  = "BALANCE";
constexpr char word_129[]  = "OF";

constexpr char word_130[]  = "NO~DECK ";
constexpr char word_131[]  = "DECK~V1 ";
constexpr char word_132[]  = "DECK~V2 ";
constexpr char word_133[]  = "DECK~V3 ";
constexpr char word_134[]  = "HACKING\nCYBERDECKS\nSAVE";
constexpr char word_135[]  = "MOVE HERE";
constexpr char word_136[]  = "-~SOLD~OUT~-\n";

#ifdef CREDITS

constexpr char word_137[]  = " CYBERHACK: PPOT~2021";
constexpr char word_138[]  = "  DEVELOPER:~FILMOTE";
constexpr char word_139[]  = " ~GRAPHICS:~VAMPIRICS ";
constexpr char word_140[]  = "TESTING:~TUXINATOR2009";
constexpr char word_141[]  = "MORAL~SUPPORT:~JESSICA";
...
constexpr uint8_t sentences_Lengths[]  {
...
constexpr uint8_t sentence_data[]  { 
