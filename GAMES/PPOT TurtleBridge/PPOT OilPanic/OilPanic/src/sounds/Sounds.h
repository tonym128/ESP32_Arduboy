...
namespace Sounds {
    ...
    const uint16_t catchOil[]  = 	    { NOTE_F3, 20, NOTE_G4, 20, TONES_END };
    const uint16_t fireStarted[]  =      { NOTE_F1, 50, NOTE_C1, 50, NOTE_A1, 50, TONES_END };
    const uint16_t scoreAdded[]  =       { NOTE_A3,180, NOTE_D3,180, NOTE_E4,180, TONES_END };
