...
namespace Sounds {
    ...
    const uint16_t Jump[]  = 	      { NOTE_F1, 15, NOTE_G2, 15, TONES_END };
    const uint16_t Key[]  =          { NOTE_A4,75, NOTE_B4, 75, NOTE_CS5,75, NOTE_G5,150, NOTE_DS5,150, TONES_END };
    const uint16_t JumpOver[]  = 		{ NOTE_A4,75, NOTE_B4, 75, TONES_END };
    const uint16_t Unlock[]  =       { NOTE_A3,180, NOTE_A3,90, NOTE_A3,90, NOTE_A3,180, NOTE_A3,180,
                                            NOTE_CS4,180, NOTE_A3,180, NOTE_CS4,180, NOTE_A3,180, TONES_END };


    const uint16_t TitleMusic[]  = {
