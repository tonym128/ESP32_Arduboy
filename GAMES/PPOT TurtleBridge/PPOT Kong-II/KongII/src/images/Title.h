...
namespace Images {
    ...
    #ifndef DEBUG
    const uint8_t  Title_Chain_Long[] = {
    8, 40,
    ...
    #ifndef DEBUG
    const uint8_t  Title_Kong_Arm_Left[] = {
    30, 31,
    ...
    #ifndef DEBUG
    const uint8_t  Title_Kong_Arm_Right[] = {
    31, 31,
