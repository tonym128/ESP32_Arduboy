...
namespace Images {
    ...
    const uint8_t  bone_portrait_highlighted[] = {
    9, 17,
    ...
    const uint8_t  bone_portrait_outline[] = {
    9, 17,
    ...
    const uint8_t  bone_portrait_outline_highlighted[] = {
    9, 17,
    ...
    const uint8_t  bone_portrait_hidden[] = {
    9, 17,
    ...
    const uint8_t  bone_portrait_hidden_highlight[] = {
    9, 17,
    ...
    const uint8_t  bone_pips_highlight[] = {
    5, 7,
