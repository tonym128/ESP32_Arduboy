...
const uint16_t wave_start[]  = {
  NOTE_C4,85, NOTE_REST,85, NOTE_C4,85, NOTE_REST,85, NOTE_C4,85, NOTE_REST,85, NOTE_C4,85, NOTE_REST,85,
  NOTE_CS4,85, NOTE_REST,85, NOTE_C4,85, TONES_END
};

const uint16_t wave_success[]  = {
...
const uint16_t enemy_fires_bullet[]  = {
...
const uint16_t player_hit_by_bullet[]  = {
  NOTE_A3,9, NOTE_D3,10, NOTE_C3,6, NOTE_F3,10, 
  TONES_END
};

const uint16_t bullets_collide[]  = {
  NOTE_A3,9, TONES_END
};
...
const uint16_t formation_launch_1[]  = {
  NOTE_B3, 9, NOTE_E3, 10, TONES_END
};

const uint16_t formation_launch_2[]  = {
  NOTE_B3, 9, NOTE_E3, 10, NOTE_REST, 30, 
  NOTE_B3, 9, NOTE_E3, 10, 
  TONES_END
};

const uint16_t formation_launch_3[]  = {
  NOTE_B3, 9, NOTE_E3, 10, NOTE_REST, 30, 
  NOTE_B3, 9, NOTE_E3, 10, NOTE_REST, 30, 
  NOTE_B3, 9, NOTE_E3, 10, TONES_END
};

const uint16_t formation_launch_4[]  = {
  NOTE_B3, 9, NOTE_E3, 10, NOTE_REST, 30, 
  NOTE_B3, 9, NOTE_E3, 10, NOTE_REST, 30, 
  NOTE_B3, 9, NOTE_E3, 10, NOTE_REST, 30, 
  NOTE_B3, 9, NOTE_E3, 10, TONES_END
