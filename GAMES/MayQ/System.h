...
extern Arduboy2Base &SystemGetArduboy(void);
...
extern void SystemReversePattern(const uint8_t *pattern, int8_t x, int8_t y, uint8_t width, int8_t flip);
