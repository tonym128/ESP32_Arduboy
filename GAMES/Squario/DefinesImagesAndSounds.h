...
enum SpriteDataLayout {
 ...
 const uint8_t SmallSquarioSprite[] {
 ...
 const uint8_t BigSquarioSprite[] {
 ...
 const uint8_t tMask[] = { 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF };
 const uint8_t tBrick[] = { 0xFF,0xA9,0xA9,0xB9,0xA9,0xEF,0xA9,0xFF };	// 3	Empty
 const uint8_t tQBlock[] = { 0xFF,0x81,0x85,0xB5,0x95,0x9D,0x81,0xFF };
 const uint8_t tBQBlock[] =		{ 0xFF,0x81,0xA5,0x81,0x81,0xA5,0x81,0xFF };	// 9

 const uint8_t tPipeLeft[] = 		{ 0x00,0x00,0xFF,0x00,0xFF,0x00,0x00,0x00 };	// 4
 const uint8_t tPipeRight[] = 		{ 0x00,0x00,0x00,0x00,0x00,0xFF,0x00,0x00 };	// 5

 const uint8_t tPipeCapLeft[] = 	{ 0xFF,0x81,0x81,0xFD,0x81,0x81,0x81,0x81 };	// 6
 const uint8_t tPipeCapRight[] = { 0x81,0x81,0x81,0x81,0x81,0x81,0x81,0xFF };	// 7
 const uint8_t tTopPipeCapLeft [] = { 
  0b11111111, //0xFF,
  0b10000001, //0x81,
  0b10000001,
  0b10111111, //0xFD,
 ...
 const uint8_t tTopPipeCapRight [] = {
  0x81,0x81,0x81,0x81,0x81,0x81,0x81,0xFF
};

// 96x32
 const uint8_t TitleSquarioText [] = {
...
// 53x32
 const uint8_t TitleSquarioGuys [] = {
...
0x00, 0x00, 0x00, 0x00, 
 ...
 const uint8_t OverworldBG [] = { // 64x16
...
// 37x24
 const uint8_t UndergroundBricks [] = {
...
#define nC6          2094 // 0xD
#define nE6          2638 // 0xE
 const uint16_t SFXFrequencies [] {
  nB1, nD2, nF2,
  nA2, nD3, nA3, nD4,
  nC5, nC5S, nD5, nD5S, nE5,
  nC6, nE6, nB5
};
 const uint8_t SFX_Pipe [] = { 0, 32, 0xD1, 0xC1, 0xB1, 0xA3, 0xD1, 0xC1, 0xB1, 0xA1, 0xFF };
 const uint8_t SFX_Hit [] = { 0, 16, 0xC1, 0xB1, 0xA1, 0x91, 0xFF };
 const uint8_t SFX_Jump [] = { 0, 16, 0x21, 0x11, 0x31, 0x21, 0xFF };
 const uint8_t SFX_Mushroom [] = { 0, 64, 0x41, 0x41, 0x51, 0x51, 0x61, 0x61, 0x71, 0x71, 0xFF };
 const uint8_t SFX_Coin [] = { 0, 16, 0xF1, 0xE4, 0xFF };
 const uint8_t SFX_Life [] = { 0, 32, 0xE3, 0xD3, 0xE3, 0xD3, 0xC5, 0x85, 0xFF };
#endif
