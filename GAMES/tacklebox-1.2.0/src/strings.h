...
const uint8_t  font_tiles_upper_mask[] = {
    0x0f, 0x0f, 0x0f, 0x0f
};

const uint8_t  font_tiles_lower_mask[] = {
    0xf0, 0xf0, 0xf0, 0xf0
};


// "SAVE"
const uint8_t save_string[5]  = {
    29, 11, 32, 15, 0xFF
};


// "SAVED OK"
const uint8_t gameSaved_string[9]  = {
    29, 11, 32, 15, 14, 0, 25, 21, 0xFF
};


// "MY FISH"
const uint8_t collection_string[8]  = {
    23, 35, 0, 16, 19, 29, 18, 0xFF
};


// "CURRENT HAUL"
const uint8_t quantity_string[13]  = {
    13, 31, 28, 28, 15, 24, 30, 0, 18, 11, 31, 22, 0xFF
};


// "BEST LENGTH CM"
const uint8_t length_string[15]  = {
    12, 15, 29, 30, 0, 22, 15, 24, 17, 30, 18, 0, 13, 23, 0xFF
};


// "CM"
const uint8_t cm_string[3]  = {
    13, 23, 0xFF
};


// "*"
const uint8_t checkmark_string[2]  = {
    37, 0xFF
};


// "DELETE"
const uint8_t delete_string[7]  = {
    14, 15, 22, 15, 30, 15, 0xFF
};


// "REALLY"
const uint8_t really_string[7]  = {
    28, 15, 11, 22, 22, 35, 0xFF
};


// "YES"
const uint8_t yes_string[4]  = {
    35, 15, 29, 0xFF
};


// "NO"
const uint8_t no_string[3]  = {
    24, 25, 0xFF
};


// "OK"
const uint8_t ok_string[3]  = {
    25, 21, 0xFF
};


// "SFX *"
const uint8_t sfxOn_string[6]  = {
    29, 16, 34, 0, 37, 0xFF
};


// "SFX"
const uint8_t sfxOff_string[4]  = {
    29, 16, 34, 0xFF
};


// "OPEN 4AM\nTO MIDNIGHT"
const uint8_t openFromTo_string[21]  = {
    25, 26, 15, 24, 0, 5, 11, 23, 42, 30, 25, 0, 23, 19, 14, 24, 19, 17, 18, 30, 0xFF
};


// "BUY"
const uint8_t buy_string[4]  = {
    12, 31, 35, 0xFF
};


// "SELL"
const uint8_t sell_string[5]  = {
    29, 15, 22, 22, 0xFF
};


// "ADVICE"
const uint8_t advice_string[7]  = {
    11, 14, 32, 19, 13, 15, 0xFF
};


// "HOURS"
const uint8_t hours_string[6]  = {
    18, 25, 31, 28, 29, 0xFF
};


// "SELL ALL FISH FOR"
const uint8_t sellFor_string[18]  = {
    29, 15, 22, 22, 0, 11, 22, 22, 0, 16, 19, 29, 18, 0, 16, 25, 28, 0xFF
};


// "USEFUL ADVICE FOR"
const uint8_t adviceFor_string[18]  = {
    31, 29, 15, 16, 31, 22, 0, 11, 14, 32, 19, 13, 15, 0, 16, 25, 28, 0xFF
};


// "YOU HAVE NO FISH\nTO SELL"
const uint8_t youHaveNoFish_string[25]  = {
    35, 25, 31, 0, 18, 11, 32, 15, 0, 24, 25, 0, 16, 19, 29, 18, 42, 30, 25, 0, 29, 15, 22, 22, 0xFF
};


// "I AM NOT BUYING\nTHOSE BOOTS"
const uint8_t notBuyingBoots_string[28]  = {
    19, 0, 11, 23, 0, 24, 25, 30, 0, 12, 31, 35, 19, 24, 17, 42, 30, 18, 25, 29, 15, 0, 12, 25, 25, 30, 29, 0xFF
};


// "0"
const uint8_t digit0_string[2]  = {
    1, 0xFF
};


// "1"
const uint8_t digit1_string[2]  = {
    2, 0xFF
};


// "2"
const uint8_t digit2_string[2]  = {
    3, 0xFF
};


// "3"
const uint8_t digit3_string[2]  = {
    4, 0xFF
};


// "4"
const uint8_t digit4_string[2]  = {
    5, 0xFF
};


// "5"
const uint8_t digit5_string[2]  = {
    6, 0xFF
};


// "6"
const uint8_t digit6_string[2]  = {
    7, 0xFF
};


// "7"
const uint8_t digit7_string[2]  = {
    8, 0xFF
};


// "8"
const uint8_t digit8_string[2]  = {
    9, 0xFF
};


// "9"
const uint8_t digit9_string[2]  = {
    10, 0xFF
};


// "GRUB"
const uint8_t grub_string[5]  = {
    17, 28, 31, 12, 0xFF
};


// "SHRIMP"
const uint8_t shrimp_string[7]  = {
    29, 18, 28, 19, 23, 26, 0xFF
};


// "PRO POLE"
const uint8_t proPole_string[9]  = {
    26, 28, 25, 0, 26, 25, 22, 15, 0xFF
};


// "OARS"
const uint8_t boatOars_string[5]  = {
    25, 11, 28, 29, 0xFF
};


// "SOME FISH ARE\nONLY IN\nDEEP WATER"
const uint8_t advice1_string[33]  = {
    29, 25, 23, 15, 0, 16, 19, 29, 18, 0, 11, 28, 15, 42, 25, 24, 22, 35, 0, 19, 24, 42, 14, 15, 15, 26, 0, 33, 11, 30, 15, 28, 0xFF
};


// "JAKE FISHES\nTHE OCEAN AT NIGHT"
const uint8_t advice2_string[31]  = {
    20, 11, 21, 15, 0, 16, 19, 29, 18, 15, 29, 42, 30, 18, 15, 0, 25, 13, 15, 11, 24, 0, 11, 30, 0, 24, 19, 17, 18, 30, 0xFF
};


// "VISIT\nCITY41.GAMES/FG"
const uint8_t advice3_string[22]  = {
    32, 19, 29, 19, 30, 42, 13, 19, 30, 35, 5, 2, 38, 17, 11, 23, 15, 29, 39, 16, 17, 0xFF
};


// "YOU KNOW ALL"
const uint8_t noMoreAdvice_string[13]  = {
    35, 25, 31, 0, 21, 24, 25, 33, 0, 11, 22, 22, 0xFF
};


// "HELP AT CITY41.GAMES/TBOX"
const uint8_t signGameManual_string[26]  = {
    18, 15, 22, 26, 0, 11, 30, 0, 13, 19, 30, 35, 5, 2, 38, 17, 11, 23, 15, 29, 39, 30, 12, 25, 34, 0xFF
};


// "WARNING SHARKS!"
const uint8_t signSharkWarning_string[16]  = {
    33, 11, 28, 24, 19, 24, 17, 0, 29, 18, 11, 28, 21, 29, 41, 0xFF
};


// "OCTOPUS TOO"
const uint8_t signOctoWarning_string[12]  = {
    25, 13, 30, 25, 26, 31, 29, 0, 30, 25, 25, 0xFF
};


// "OCEAN FISH HATE WORMS"
const uint8_t signOceanFish_string[22]  = {
    25, 13, 15, 11, 24, 0, 16, 19, 29, 18, 0, 18, 11, 30, 15, 0, 33, 25, 28, 23, 29, 0xFF
};


// "BRING ME THREE\nLOBSTERS AND I WILL\nSELL YOU NICE BAIT"
const uint8_t girlQuest_string[54]  = {
