 ...
 uint8_t PROGMEM levelCompletedText[] = 
{
 ...
 uint8_t PROGMEM retryLevelText[] = 
{
 ...
 uint8_t PROGMEM missionCompletedText[] = 
{
  AT_X(1), AT_Y(6),
 ...
 uint8_t PROGMEM menuText[] = 
{
 ...
 uint8_t PROGMEM shortMenuPos[2][2] =
{
  {21, 21},
  {38, 33},
};

 uint8_t PROGMEM shortMenuText[] = 
{
  AT_X(31), AT_Y(22),
  'C','O','N','T','I','N','U','E',
  AT_X(48), AT_Y(33),
