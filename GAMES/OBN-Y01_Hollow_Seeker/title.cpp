...
/*  Local Variables  */
 ...
 static const uint8_t imgTitle1[] = { // "Hollow" 84x20
 ...
 static const uint8_t imgTitle2[] = { // "Seeker" 80x20
 ...
 static const uint8_t imgMan[] = { // 40x40
 ...
 static const uint8_t imgEyes[] = { // 10x8x3
 ...
 static const uint8_t imgHeadLight[] = { // 7x8
    0x3C, 0x7E, 0xFF, 0xFF, 0xFF, 0x7E, 0x3C,
};

 static const byte sound1[] = {
    0x90, 69, 0, 10, 0x80, 0xF0
};

 static const byte sound2[] = {
    0x90, 74, 0, 20, 0x80, 0xF0
};

 static const char menuGame[] = "START GAME";
 static const char menuSound[] = "SOUND ";
 static const char menuRecord[] = "RECORD";
 static const char menuCredit[] = "CREDIT";

 static const char * const menusTable[] = {
    menuGame, menuSound, menuRecord, menuCredit
};

 static const char credit0[] = "- " APP_TITLE " -";
 static const char credit1[] = APP_RELEASED;
 static const char credit2[] = "PROGREMMED BY OBONO";
 static const char credit3[] = "THIS PROGRAM IS";
 static const char credit4[] = "RELEASED UNDER";
 static const char credit5[] = "THE MIT LICENSE.";

 static const char * const creditsTable[] = {
...
void drawTitle(void)
{
    if (toDraw) {
        ...
        case STATE_MENU:
            ...
            for (int i = 0; i < 4; i++) {
                p = (char *)pgm_read_dword(menusTable + i);
                strcpy_P(buf, p);
        ...
        case STATE_CREDIT:
            for (int i = 0; i < 8; i++) {
                p = (char *)pgm_read_dword(creditsTable + i);
                if (p != NULL) {
                    strcpy_P(buf, p);
