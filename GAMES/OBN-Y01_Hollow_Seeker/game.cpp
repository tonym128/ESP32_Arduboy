...
/*  Local Variables  */
 ...
 static const uint8_t imgPlayer[] = {
 ...
 static const uint8_t imgReady[] = { // "Ready?" 64x16
 ...
 static const uint8_t imgGameOver[] = { // "GameOver" 88x16
 ...
 static const uint8_t imgNumber[] = { // 8x16x10
 ...
 static const byte soundMove[] = {
    0x90, 67, 0, 10, 0x90, 79, 0, 10, 0x90, 76, 0, 10, 0x80, 0xF0
};

 static const byte soundCrush[] = {
    0x90, 20, 0x91, 19, 1, 244, 0x80, 0x81, 0xF0
};

 static const byte soundGameOver[] = {
...
static signed char     caveHollowCnt;
...
static signed char     playerJump;  // -8...8
...
void drawGame(void)
{
    ...
    /*  Player  */
    int playerY = caveColumn[playerColumn].bottom-8 + playerJump * playerMove / 8;
