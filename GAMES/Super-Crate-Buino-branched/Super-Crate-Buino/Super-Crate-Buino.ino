...
///////////////////////////////////////////// SOUNDS
const uint16_t player_damage_sound[]  = {NOTE_B4, 250, TONES_END};
const uint16_t revolver_sound[]  = {NOTE_F5, 50, NOTE_A3, 50, NOTE_GS3, 50, NOTE_G3, 50, NOTE_FS3, 50, TONES_END};
const uint16_t grenade_sound[]  = {NOTE_A3, 50, TONES_END};
const uint16_t machinegun_sound[]  = {NOTE_D4, 50, NOTE_A3, 100, NOTE_GS3, 100, NOTE_G3, 50, TONES_END};
const uint16_t rocket_sound[]  = {NOTE_A4, 3000, TONES_END};
...
const uint16_t jump_sound[]  = {NOTE_G4, 50, NOTE_GS4, 50, NOTE_A4, 50, TONES_END};
const uint16_t enemy_felt_sound[]  = {NOTE_FS3, 750, TONES_END};
const uint16_t shotgun_sound[]  = {NOTE_B3, 150, TONES_END};
const uint16_t laser_sound[]  = {NOTE_D5, 50, NOTE_CS5, 50, NOTE_C5, 50, NOTE_B4, 50, NOTE_AS4, 50, NOTE_A4, 50, TONES_END};
...
const byte smallEnemyBitmap[][10]  = {
