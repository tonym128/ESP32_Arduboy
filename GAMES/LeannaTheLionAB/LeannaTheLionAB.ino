...
const unsigned char  lion_plus_mask[] =
{
  // width, height,
  24, 8,
  // FRAME 00
...
const unsigned char  adulthuman_plus_mask[] =
{
  // width, height,
  8, 16,
  // FRAME 00
...
const unsigned char  monkey_plus_mask[] =
{
  // width, height,
  8, 8,
  // FRAME 00
...
const unsigned char  monkeypoo_plus_mask[] =
{
  // width, height,
  16, 8,
  // FRAME 00
...
const unsigned char  elephant_plus_mask[] =
{
  // width, height,
  32, 32,
  // FRAME 00
...
const unsigned char  child_plus_mask[] =
{
  // width, height,
  8, 16,
  // FRAME 00
...
const unsigned char  elder_plus_mask[] =
{
  // width, height,
  8, 16,
  // FRAME 00
...
const unsigned char  adult_plus_mask[] =
{
  // width, height,
  8, 16,
  // FRAME 00
...
const unsigned char  waterpuddle_plus_mask[] =
{
  // width, height,
  16, 8,
  // FRAME 00
...
const unsigned char  truck_plus_mask[] =
{
  // width, height,
  32, 32,
  // FRAME 00
...
const unsigned char  zookeeper_plus_mask[] =
{
  // width, height,
  16, 16,
  // FRAME 00
...
const unsigned char  cage_plus_mask[] =
{
  // width, height,
  32, 16,
  // FRAME 00
...
const unsigned char  backgroundfence_plus_mask[] =
{
  // width, height,
  16, 16,
  // FRAME 00
...
const unsigned char  foregroundfence_plus_mask[] =
{
  // width, height,
  32, 8,
  // FRAME 00
...
const unsigned char  angledtranqdart_plus_mask[] =
{
  // width, height,
  8, 8,
  // FRAME 00
...
const unsigned char  tranqdart_plus_mask[] =
{
  // width, height,
  8, 8,
  // FRAME 00
...
const unsigned char  hotsauce_plus_mask[] =
{
// width, height,
8, 8,
// FRAME 00
...
const uint16_t SND_INTRO_MUSIC[]  = {
  200,100,
  0,100,
  200,100,
  0,100,
...
const uint16_t SND_EATING[]  = {
  320,200,
  TONES_END 
};

const uint16_t SND_HUNTER[]  = {
  50,100,
  100,500,
  TONES_END 
};

const uint16_t SND_ELEPHANT[]  = {
  350,100,
  500,500,
  TONES_END 
};
...
const char hi_score_text[]  = "HI SCORE:";
#define TRAMPLED_TEXT 1
#define KNOCKED_OUT_TEXT 2
#define CAGED_TEXT 3
const char trampled_text[]  = "TRAMPLED";
const char knocked_out_text[]  = "KNOCKED OUT";
const char caged_text[]  = "CAGED";
int8_t gameover_type = 0;
int8_t gameover_text_id = 0;
const char gameover1_text[]  = "What, no mint?";
const char gameover2_text[]  = "All that fast food\nwas worth it.";
const char gameover3_text[]  = "Bones can be\ntoothpicks, I suppose.";
const char gameover4_text[]  = "I demand to see your\nmanager. I'm sure\nthey'll be delicious.";

const char story_text[]  = "Leanna may be a lion,\nbut she knows what\nshe wants: She wants\nfresh meat from her\nfavorite restaurant.\nThe zoo had to close";
...
bool Save() {
  if(SAVE_HIGH_SCORE){
    ...
    for(uint16_t i=0;i<2;i++){// write the f
      EEPROM.put(startAddress+i, *((char*)&high_score_data + i) );
      EEPROM.commit();
    }   
    return true;
  }
