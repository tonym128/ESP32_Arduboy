...
const char gameTitle[]     = "GLOVE\0         "; // max 10 (field 16)
const char gameSubTitle[]  = "\0              "; // max 20 (field 21)
const char gameRandom[]    = "random mode";

const char titleNormal[]  = "Glove";
const char titleRandom[]  = "Random";
