...
const char optionsMenuItems_0[]  = "[   Options Menu    ]";
const char optionsMenuItems_1[]  = "Sound:";
const char optionsMenuItems_2[]  = "Play";
const char optionsMenuItems_3[]  = "Reset Game Data";

const char* const optionsMenuItems[]  = {
    optionsMenuItems_0,
    optionsMenuItems_1,
    optionsMenuItems_2,
    optionsMenuItems_3
...
const char clearSaveConfirmItems_0[]  = "[REALLY CLEAR SAVE??]";
const char clearSaveConfirmItems_1[]  = "No, whoops!";
const char clearSaveConfirmItems_2[]  = "Yes, I'm sure.";

const int8_t optionsMenuItemsCount = 3;

const char* const clearSaveMenuItems[]  = {
