...
t_tones sfx_dudegrab[]  = {
    240,10, 260,20, 280,30, 300,40, 280,50,
    TONES_END
};

t_tones sfx_dudeenter[]  = {
...
t_tones sfx_menutoggle[]  = {
    330,20, 385,15, 330,20, 385,15,330,20, 385,15, 
    TONES_END
};

t_tones sfx_menuselect[]  = {
    330,10, 
    TONES_END
};

t_tones sfx_menuclick[]  = {
