...
#define BOSS_SHOOTS                  11
 ...
 const unsigned char Levels[8][12] = {
...
const char string_1[]  = "1 counterattack";
const char string_2[]  = "2 they keep coming";
const char string_3[]  = "3 harakiri";
const char string_4[]  = "4 they are everywhere";
const char string_5[]  = "5 getting bigger";
const char string_6[]  = "6 keep shooting";
const char string_7[]  = "7 oh oh";
const char string_8[]  = "8 the final countdown";

const char* const string_table[]  = {string_1, string_2, string_3, string_4, string_5, string_6, string_7, string_8};

void levelintro(byte level)
{
  drawstring((const char*)pgm_read_ptr(&(string_table[level])), 2, 8);
}
